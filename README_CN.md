...
<p align="center">
  <b>Max Knowledge Brain for Java</b> —— 让 Java 团队零门槛拥有企业级 AI 大脑<br/>
  基于 <b>Java 21 + Spring Boot 3（虚拟线程）</b>构建的开箱即用、模型中立的 <b>RAG + LLM 工作流引擎</b><br/>
  <sub>智能客服 · 企业知识库 · 数据分析 · 学术研究与教育</sub>
</p>
...
| 🎙️ 多模态                      | **多模态融合向量**：文档中文本与图片融合为统一向量，支持图文混合的跨模态检索（阿里云百炼 / 火山方舟视觉向量模型）；ASR 语音识别、TTS 语音合成、OCR 图像识别、Stable Diffusion 图像生成 |
...
> **MaxKB4j 没有商业公司背书、没有融资**，由个人开发者利用业余时间一行行代码堆出来。
> 你的每一份支持，都会直接投入这些真实开销：
>
> - 🖥 **在线 Demo 云服务器** —— 7×24 小时运行，供所有人免费体验
> - 🤖 **模型 Token 消耗** —— 每一次功能回归测试都在真实烧钱
> - 🧪 **Bug 修复与新功能研发** —— 深夜编码的咖啡因补给
>
> 赞助使用情况会在交流群定期公示，透明可见。
>
> ⚠️ 作者精力有限：**微信直连与核心交流群仅向赞助用户开放**（¥10 起）—— 这既是对作者时间的保护，也是对群内交流质量的保证。

### 赞助档位

|    档位    |  金额   | 核心权益                                                                        | 适合人群                  |
|:--------:|:-----:|:----------------------------------------------------------------------------|:----------------------|
| ☕ 请作者喝咖啡 |  ¥10  | 作者微信直连 + 核心交流群 + 项目更新优先通知                                                   | 认可项目价值、想和作者交个朋友       |
| 📚 学习会员  |  ¥99  | 咖啡档全部权益 + 免费加入 [知识星球](https://wx.zsxq.com/group/28882525858841) + 星球内问题优先解答 | 想系统学习 RAG / 工作流落地的开发者 |
| 🏢 企业伙伴  | ¥799  | 学习会员全部权益 + 一次性获取前端源码 + 部署 / 售后技术支持                                          | 要在生产环境上线的团队           |
| 👑 战略合作  | ¥1399 | 企业伙伴全部权益 + 6 个月内前端源码免费升级 + 企业 Logo 长期展示于赞助墙                                 | 深度绑定、共同成长的伙伴          |

> 💡 **所有档位均包含「作者微信直连 + 核心交流群」**，从 ¥10 咖啡档起即可解锁。

### 如何赞助（三步完成）

<table>
  <tr>
    <th align="center">第 1 步 · 加作者微信</th>
    <th align="center">第 2 步 · 扫码支付（支付宝）</th>
    <th align="center">第 2 步 · 扫码支付（微信）</th>
  </tr>
  <tr>
    <td align="center"><img src="image/wx.jpg" width="200" alt="作者微信二维码"/></td>
    <td align="center"><img src="image/zfb_skm.png" width="200" alt="支付宝赞赏码"/></td>
    <td align="center"><img src="image/wx_zsm.png" width="200" alt="微信赞赏码"/></td>
  </tr>
  <tr>
    <td align="center">备注「MaxKB4j」</td>
    <td align="center" colspan="2">第 3 步 · 发送付款截图给作者（备注昵称更佳），权益立即生效</td>
  </tr>
</table>

### 🏅 赞助墙

> 🎯 期待你的加入 —— 你的企业 Logo / 昵称将按赞助顺序长期展示于此，获得社区持续曝光。
...
你好，我是**泰山（TARZAN）**，MaxKB4j 的作者。

这个项目始于一个简单的想法：**Java 世界值得一个原生的、生产级的 AI 应用平台**
。没有商业公司、没有融资，全部代码、文档、测试与部署脚本，都是我利用下班后和周末的时间完成的，交流群里的每一个问题，我也会尽量亲自回复。

如果这个项目帮到了你，欢迎用行动支持它：

- ⭐ **点一个 Star** —— 让更多 Java 开发者看到它，10 秒钟，对我意义重大
- 💖 **[请我喝杯咖啡](#支持与赞助)**（¥10 起）—— 即可解锁作者微信直连与核心交流群，你的赞助会变成服务器、Token 和咖啡因，让项目走得更远
...
本项目采用 [GNU GPLv3](https://www.gnu.org/licenses/gpl-3.0.html)
许可证（“许可证”）。除非遵守许可证条款，否则不得使用本项目文件；依据本许可分发的软件按“原样”提供，不附带任何明示或暗示的担保或条件。
