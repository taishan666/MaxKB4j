...
public class GenerateProblemEvent extends ApplicationEvent {
    ...
    public GenerateProblemEvent(Object source, String knowledgeId,List<String> documentIdList, String modelId,Integer number, String prompt, List<String> stateList) {
        super(source);
