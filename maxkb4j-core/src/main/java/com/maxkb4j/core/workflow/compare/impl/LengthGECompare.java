package com.maxkb4j.core.workflow.compare.impl;


import com.maxkb4j.core.workflow.compare.Compare;

import java.util.List;

public class LengthGECompare implements Compare {
    @Override
    public boolean support(String compare) {
        return compare.equals("len_ge");
    }
