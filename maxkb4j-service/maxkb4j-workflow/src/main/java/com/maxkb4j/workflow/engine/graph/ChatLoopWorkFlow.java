...
@Getter
@Setter
public class ChatLoopWorkFlow extends WorkflowImpl implements ILoopWorkFlow{
     ...
     * @param sink       输出 Sink
     */
    public ChatLoopWorkFlow(ChatWorkflow workflow, List<AbsNode> nodes, List<LfEdge> edges,
