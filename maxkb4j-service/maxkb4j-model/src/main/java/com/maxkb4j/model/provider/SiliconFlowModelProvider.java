...
public class SiliconFlowModelProvider extends OpenAiModelProvider {
    ...
    private static final List<ModelInfo> MODEL_INFOS = List.of(
            new ModelInfo("deepseek-ai/DeepSeek-V3.2", "", ModelType.LLM, new OpenAiChatModelParams()),
            new ModelInfo("Pro/moonshotai/Kimi-K2.5", "", ModelType.LLM, new OpenAiChatModelParams()),
            new ModelInfo("Qwen/Qwen3-VL-32B-Thinking", "", ModelType.LLM, new OpenAiChatModelParams()),
            new ModelInfo("Pro/zai-org/GLM-4.7", "", ModelType.LLM, new OpenAiChatModelParams()),
            new ModelInfo("Pro/MiniMaxAI/MiniMax-M2.1", "", ModelType.LLM, new OpenAiChatModelParams()),
            new ModelInfo("tencent/Hunyuan-MT-7B", "", ModelType.LLM, new OpenAiChatModelParams()),
            ...
            new ModelInfo("Qwen/Qwen3-VL-32B-Thinking", "", ModelType.VISION, new OpenAiChatModelParams()),
