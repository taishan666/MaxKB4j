 ...
 */
@Service
public class ApplicationAccessTokenServiceImpl extends ServiceImpl<ApplicationAccessTokenMapper, ApplicationAccessTokenEntity> implements IApplicationAccessTokenService {
