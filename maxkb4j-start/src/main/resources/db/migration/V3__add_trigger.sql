...
-- ----------------------------
ALTER TABLE "public"."event_trigger"
...
-- ----------------------------
ALTER TABLE "public"."event_trigger_task"
    ADD CONSTRAINT "event_trigger_task_pkey" PRIMARY KEY ("id");
...
(
    ...
    "source_id"       varchar(50)                                 NOT NULL,
    "task_record_id"  varchar(50)                                 NOT NULL,
    "meta"            jsonb                                       NOT NULL,
...
-- ----------------------------
ALTER TABLE "public"."event_trigger_task_record"
    ADD CONSTRAINT "event_trigger_task_record_pkey" PRIMARY KEY ("id");
