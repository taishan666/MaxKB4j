...
-- ----------------------------
-- Sequence structure for setting_modelparam_id_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."setting_modelparam_id_seq";
CREATE SEQUENCE "public"."setting_modelparam_id_seq"
    INCREMENT 1
MINVALUE  1
...
CREATE TABLE "public"."application_chat_record" (
                                                    ...
                                                    "improve_paragraph_id_list" varchar(50)[] NOT NULL,
...
CREATE TABLE "public"."application_public_access_client" (
                                                             ...
                                                             "id" varchar(50) NOT NULL,
                                                             "access_num" int4 NOT NULL,
                                                             "intraday_access_num" int4 NOT NULL,
                                                             "application_id" varchar(50) NOT NULL
)
;
...
CREATE TABLE "public"."dataset" (
                                    ...
                                    "meta" jsonb NOT NULL,
                                    "user_id" varchar(50) NOT NULL,
                                    "embedding_mode_id" varchar(50) NOT NULL
)
;
...
-- ----------------------------
-- Table structure for setting_modelparam
-- ----------------------------
DROP TABLE IF EXISTS "public"."setting_modelparam";
CREATE TABLE "public"."setting_modelparam" (
...
-- ----------------------------
ALTER SEQUENCE "public"."setting_modelparam_id_seq"
    OWNED BY "public"."setting_modelparam"."id";
SELECT setval('"public"."setting_modelparam_id_seq"', 1, false);
...
CREATE INDEX "application_tts_model_id_63215f2e" ON "public"."application" USING btree (
    "tts_model_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
CREATE INDEX "application_user_id_e0323977" ON "public"."application" USING btree (
    "user_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "application_chat_record_chat_id_21aeb7ef" ON "public"."application_chat_record" USING btree (
    "chat_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "application_dataset_mapping_dataset_id_a14a235a" ON "public"."application_dataset_mapping" USING btree (
    "dataset_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "dataset_embedding_mode_id_03b88255" ON "public"."dataset" USING btree (
    "embedding_mode_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "embedding_document_id_3c89d1f3" ON "public"."embedding" USING btree (
    "document_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "embedding_paragraph_id_9f39681c" ON "public"."embedding" USING btree (
    "paragraph_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "problem_paragraph_mapping_problem_id_937b9858" ON "public"."problem_paragraph_mapping" USING btree (
    "problem_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
-- ----------------------------
-- Primary Key structure for table setting_modelparam
-- ----------------------------
ALTER TABLE "public"."setting_modelparam" ADD CONSTRAINT "setting_modelparam_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "team_member_team_id_26812b86" ON "public"."team_member" USING btree (
    "team_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
CREATE INDEX "team_member_permission_member_id_01dc944b" ON "public"."team_member_permission" USING btree (
    "member_id" "pg_catalog"."varchar_pattern_ops" ASC NULLS LAST
    );
...
-- ----------------------------
ALTER TABLE "public"."dataset" ADD CONSTRAINT "dataset_embedding_mode_id_03b88255_fk_model_id" FOREIGN KEY ("embedding_mode_id") REFERENCES "public"."model" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION DEFERRABLE INITIALLY DEFERRED;
