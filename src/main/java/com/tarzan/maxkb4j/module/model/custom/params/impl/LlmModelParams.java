...
public  class LlmModelParams implements ModelParams {
    ...
    public List<BaseField> toForm() {
        ...
        BaseField sliderFiled2=new SliderFiled(0.1f,1,0.1f,2,"topP","topP","",1);
        BaseField sliderFiled3=new SliderFiled(1,100000,1,0,"输出最大Tokens","maxTokens","指定模型可生成的最大token个数",800);
        BaseField switchField=new SwitchField("是否为多模态模型","isMultimodalModel","是否为多模态模型",false);
        return List.of(sliderFiled,sliderFiled1,sliderFiled2,sliderFiled3,switchField);
    }
}
