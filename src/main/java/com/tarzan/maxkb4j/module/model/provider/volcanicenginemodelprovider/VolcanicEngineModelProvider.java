package com.tarzan.maxkb4j.module.model.provider.volcanicenginemodelprovider;
...
@Component
public class VolcanicEngineModelProvider implements IModelProvider {
    @Override
    public ModelProvideInfo getModelProvideInfo() {
        ModelProvideInfo info = new ModelProvideInfo();
        info.setProvider("model_volcanic_engine_provider");
        info.setName("火山引擎");
