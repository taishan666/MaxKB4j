...
import com.tarzan.maxkb4j.module.model.provider.impl.aliyunModelProvider.params.QWenTTSParams;
...
public class AliYunBaiLianModelProvider extends IModelProvider {
    ...
    public List<ModelInfo> getModelList() {
      ...
      //  modelInfos.add(new ModelInfo(QwenModelName.TEXT_EMBEDDING_V2,"文本向量模型", ModelTypeEnum.EMBEDDING.name(),new BaiLianEmbedding()));
        ...
        modelInfos.add(new ModelInfo("cosyvoice-v1","语言生成模型",ModelTypeEnum.TTS.name(),new BaiLianTextToSpeech(),new QWenTTSParams()));
        modelInfos.add(new ModelInfo("qwen-tts","语言生成模型",ModelTypeEnum.TTS.name(),new QWenTTS(),new QWenTTSParams()));
