...
public abstract class BaseToResponse {
     ...
     */
    public abstract void toBlockResponse(String chatId, String chatRecordId, String content, boolean isEnd,
                                         int completionTokens, int promptTokens, Map<String, Object> otherParams,
                                         int status);
