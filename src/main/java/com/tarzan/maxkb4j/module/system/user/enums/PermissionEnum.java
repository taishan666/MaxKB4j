...
public enum PermissionEnum {
    ...
    APPLICATION_OVERVIEW_PUBLIC_ACCESS(ResourceType.APPLICATION, "APPLICATION_OVERVIEW", "READ+PUBLIC_ACCESS", Permission.MANAGE),
    APPLICATION_OVERVIEW_ACCESS(ResourceType.APPLICATION, "APPLICATION_OVERVIEW", "READ+ACCESS", Permission.MANAGE),
    APPLICATION_OVERVIEW_EMBED(ResourceType.APPLICATION, "APPLICATION_OVERVIEW", "READ+EMBED", Permission.MANAGE),
    APPLICATION_OVERVIEW_API_KEY(ResourceType.APPLICATION, "APPLICATION_OVERVIEW", "READ+API_KEY", Permission.MANAGE),
    ...
    APPLICATION_CHAT_LOG_ADD_KNOWLEDGE(ResourceType.APPLICATION, "APPLICATION_CHAT_LOG", "READ+ADD_KNOWLEDGE", Permission.MANAGE),
    APPLICATION_CHAT_LOG_CLEAR_POLICY(ResourceType.APPLICATION, "APPLICATION_CHAT_LOG", "READ+CLEAR_POLICY", Permission.MANAGE),
    APPLICATION_CHAT_LOG_ANNOTATION(ResourceType.APPLICATION, "APPLICATION_CHAT_LOG", "READ+ANNOTATION", Permission.MANAGE),
    ...
    KNOWLEDGE_VECTOR(ResourceType.KNOWLEDGE, "KNOWLEDGE", "READ+VECTOR", Permission.MANAGE),
    KNOWLEDGE_GENERATE(ResourceType.KNOWLEDGE, "KNOWLEDGE", "READ+GENERATE", Permission.MANAGE),
    KNOWLEDGE_SYNC(ResourceType.KNOWLEDGE, "KNOWLEDGE", "READ+SYNC", Permission.MANAGE),
    ...
    KNOWLEDGE_DOCUMENT_VECTOR(ResourceType.KNOWLEDGE, "KNOWLEDGE_DOCUMENT", "READ+VECTOR", Permission.MANAGE),
    KNOWLEDGE_DOCUMENT_GENERATE(ResourceType.KNOWLEDGE, "KNOWLEDGE_DOCUMENT", "READ+GENERATE", Permission.MANAGE),
    KNOWLEDGE_DOCUMENT_SYNC(ResourceType.KNOWLEDGE, "KNOWLEDGE_DOCUMENT", "READ+SYNC", Permission.MANAGE),
    KNOWLEDGE_DOCUMENT_MIGRATE(ResourceType.KNOWLEDGE, "KNOWLEDGE_DOCUMENT", "READ+MIGRATE", Permission.MANAGE),
    KNOWLEDGE_DOCUMENT_DOWNLOAD(ResourceType.KNOWLEDGE, "KNOWLEDGE_DOCUMENT", "READ+DOWNLOAD", Permission.MANAGE),
    ...
    KNOWLEDGE_PROBLEM_RELATE(ResourceType.KNOWLEDGE, "KNOWLEDGE_PROBLEM", "READ+RELATE", Permission.MANAGE),
