...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        int shiYaoPos = getShiYaoPos(benGua);
        int yingYaoPos = getYingYaoPos(shiYaoPos);
        ...
        for (int i = benGua.length() - 1; i >= 0; i--) {
            ...
            String shiYao = (shiYaoPos - 1) == i ? "世" : "";
            String yingYao = (yingYaoPos - 1) == i ? "应" : "";
    ...
    public static int getShiYaoPos(String gua) {
    ...
    public static int getYingYaoPos(int shiYaoIndex) {
