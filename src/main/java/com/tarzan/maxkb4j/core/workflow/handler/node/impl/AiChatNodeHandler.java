...
public class AiChatNodeHandler implements INodeHandler {
    ...
    public NodeResult execute(Workflow workflow, INode node) throws Exception {
        ChatNodeParams nodeParams = node.getNodeData().toJavaObject(ChatNodeParams.class);
    ...
    private NodeResult writeContextStream(ChatNodeParams nodeParams, TokenStream tokenStream, Workflow workflow,INode node) {
